                    ...
                    <div class="card shadow-lg detail-card">
                        ...
                        <div class="tracking-wrapper">
                            ...
                            <div class="status-card {{ $reporter->status == 5 ? 'rejected' : '' }}">
                                ...
                                <div class="status-description">
                                    <p id="status-description">
                                        @if($reporter->status == 5)
                                            ...
                                            <br><br><strong>Alasan Penolakan:</strong><br>
                                ...
                                {{-- Tombol "Hubungi Admin" akan diinjeksi oleh JS jika statusnya ditolak --}}
    ...
    const trackReportModule = (function() {
        ...
        const trackingStepsData = {
            ...
            5: {
                ...
                // Mengambil alasan penolakan dari data $reporter yang sudah ada di PHP
                ...
                progress: 100,
                hasAction: true,
                actionText: "Hubungi Admin", // Ubah teks tombol aksi
                actionType: "contact_admin", // Ubah tipe aksi menjadi contact_admin
        ...
        function updateStatusCardOnly(stepNumber) {
            ...
            // Handle rejected state for status card
            ...
            setTimeout(() => {
                ...
                const rejectionReasonDiv = statusCard.querySelector('.rejection-reason');
                ...
                if (rejectionReasonDiv) {
                    if (stepData.isRejected) {
                        ...
                        // Update the rejection reason text if necessary (it's already in the description, so might not need separate update here)
                        // rejectionReasonDiv.querySelector('.reason-text').innerHTML = 'Your specific rejection reason here';
                    } else {
        ...
        function updateStatusCard(stepNumber) {
            ...
            setTimeout(() => {
                ...
                if (rejectionReasonDiv) {
                    if (stepData.isRejected) {
                        rejectionReasonDiv.style.display = 'block';
                        // Update the rejection reason text if necessary
                    } else {
                        rejectionReasonDiv.style.display = 'none';
                    }
                }
        ...
        function restoreOriginalStepStates() {
            ...
            document.querySelectorAll('.timeline-step').forEach((step, index) => {
                ...
                if (stepNumber === 5) { // Hide the rejected step for normal flow
        ...
        function initializeElegantTracking(currentStep) {
            ...
            if (currentStep === 5) { // If status is rejected
                updateRejectedTimeline();
        ...
        function openLightbox(index) {
            ...
            if (currentMedia.isVideo) {
                ...
                lightboxImage.onerror = function() {
                    loading.style.none = 'none'; // Corrected from display
        ...
        function closeLightbox(event) {
            // Check if the click was on the lightbox background or close button, not on the content itself
            if (event && event.target !== event.currentTarget &&
                !event.target.classList.contains('lightbox-close') &&
                !event.target.classList.contains('lightbox-nav') &&
                !event.target.closest('.lightbox-video-controls')) {
                return;
            }
        ...
        return {
            ...
            contactAdmin: contactAdmin // Make contactAdmin accessible
        };
    })();
