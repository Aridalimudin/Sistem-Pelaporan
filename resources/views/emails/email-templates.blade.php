...
<body>
    ...
    <div class="email-container" id="email-diterima">
        ...
        <div class="email-body">
            ...
            <h3>Halo, Pelapor yang Terhormat</h3>
            ...
            <div class="info-box">
                <strong>📅 Tanggal Diterima:</strong> 22 Mei 2025, 14:30 WIB<br>
                <strong>⏱️ Estimasi Verifikasi:</strong> 1-2 hari kerja<br>
                <strong>👤 Petugas yang Menangani:</strong> Tim Verifikasi MTS AR-RIYADL
            </div>
