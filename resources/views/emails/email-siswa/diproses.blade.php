...
<body>
    <div class="email-container">
        <div class="email-header diproses">
            ...
            <p>Tim kami sedang menangani laporan Anda secara aktif.</p>
        </div>
        ...
        <div class="email-body">
            ...
            <p>Terima kasih telah melengkapi data. Laporan Anda kini sedang dalam tahap penanganan aktif. Tim terkait telah memulai proses investigasi sesuai prosedur.</p>
            ...
            <div class="progress-tracker">
                ...
                <div class="progress-steps">
                    <div class="progress-line"><div class="progress-line-active" style="width: 85%;"></div></div>
                    ...
                    <div class="progress-step">
                        <div class="step-circle current diproses">3</div>
            ...
            <div class="alert-box process">
                ...
                Tim kami sedang melakukan investigasi dan mengambil langkah yang diperlukan. Anda akan kami hubungi jika ada informasi baru atau memerlukan klarifikasi.
            </div>
