        ...
        <div class="email-body">
            ...
            <div class="progress-tracker">
                ...
                <div class="progress-steps">
                    <div class="progress-line"><div class="progress-line-active" style="width: 100%;"></div></div>
                    ...
                    <div class="progress-step">
                        ...
                        <div class="step-date">14 Jul 2025 14:00</div>
                    </div>
                    <div class="progress-step">
                        <div class="step-circle current selesai">4</div>
                        <div class="step-label">Selesai</div>
                        <div class="step-date">16 Jul 2025 11:30</div>
                    </div>
                </div>
            </div>
            ...
            <div class="next-steps">
                ...
                <ul>
                    ...
                    <li>Semua pihak telah mendapat pembinaan & tindakan yang sesuai</li>
            ...
            <div class="rating-prompt-box" style="background-color: #e0f2f7; border: 1px solid #b3e5fc; text-align: center;">
                <h4>✨ Berikan Penilaian Anda!</h4>
                <p>Masukan Anda sangat penting bagi kami. Mohon berikan rating kepuasan Anda terhadap proses penanganan laporan ini.</p>
                <a href="{{route('track', ['code' => $report->code])}}" class="btn-track">➡️ Beri Rating Sekarang</a>
            </div>
