...
<body>
    <div class="email-container">
        <div class="email-header verifikasi">
            <span class="header-icon">⚠️</span>
            <h2>BUTUH INFORMASI TAMBAHAN</h2>
            <p>Laporan Anda memerlukan kelengkapan data untuk diproses lebih lanjut.</p>
        </div>

        <div class="email-body">
            <div class="status-badge verifikasi">Status: Verifikasi & Kelengkapan</div>
            <h3>Assalamu'alaikum, Ananda {{$report->student?->name}} yang Terhormat</h3>
            <p>Alhamdulillah, laporan Anda telah diterima oleh tim kami. Untuk melanjutkan ke tahap investigasi, kami membutuhkan beberapa informasi tambahan dari Anda.</p>
            ...
            <div class="info-box">
                ...
                <strong>👤 Penerima:</strong> {{Auth::user()->name}}<br>
            </div>
            ...
            <div class="progress-tracker">
                ...
                <div class="progress-steps">
                    ...
                    <div class="progress-step">
                        <div class="step-circle current verifikasi">2</div>
                        <div class="step-label">Melengkapi Data</div>
                        <div class="step-date">14 Jul 2025 09:15</div>
                    </div>
                    <div class="progress-step">
            ...
            <div class="alert-box warning">
                <strong>⚠️ Perhatian: Mohon Lengkapi Data Laporan!</strong><br>
                Untuk melanjutkan ke proses investigasi, silakan klik tombol di bawah untuk melengkapi detail waktu, lokasi, pihak terlibat, dan bukti pendukung lainnya.
            </div>

            <div class="next-steps">
                <h4>📋 Langkah Selanjutnya:</h4>
                <ul>
                    <li>Segera Lengkapi Dokumen: Kunjungi halaman pelacakan laporan Anda untuk mengisi data-data yang dibutuhkan.</li>
            ...
            <div style="text-align: center; margin-top: 25px;">
                <a href="{{route('track', ['code' => $report->code])}}" class="btn-track" style="background-color: #ffc107;">➡️ Lengkapi Dokumen Laporan</a>
            </div>
        </div>
