...
<body>
    <div class="email-container">
        <div class="email-header reminder">
            ...
            <p>Ada laporan yang belum diproses melebihi batas waktu.</p>
        </div>
        <div class="email-body">
            <h3>Assalamu'alaikum, Ibu/Bapak yang Terhormat</h3>
            <p>Kami ingin mengingatkan Anda mengenai laporan dengan kode {{$report->code}} yang belum ditindaklanjuti. Laporan ini telah masuk sistem pada tanggal 13 Juli 2025 dan membutuhkan perhatian Anda segera.</p>
            <div class="info-box">
            ...
            <div style="text-align: center; margin-top: 25px;">
                <a href="{{route('track', ['code' => $report->code])}}" class="btn-action orange">➡️ Periksa Laporan Ini</a>
            </div>
        </div>
