...
<body>
    <div class="email-container">
        <div class="email-header new-report">
            ...
            <p>Sebuah laporan baru telah masuk dan membutuhkan verifikasi awal.</p>
        </div>
        <div class="email-body">
            <h3>Assalamu'alaikum, Ibu/Bapak yang Terhormat</h3>
            <p>Sistem menginformasikan bahwa ada satu laporan baru yang telah dikirimkan oleh siswa dan saat ini menunggu approval dari Anda untuk menentukan apakah laporan dapat ditindaklanjuti atau tidak.</p>
            <div class="info-box">
            ...
            <div class="alert-box primary">
                <strong>📥 Laporan Baru Menunggu Verifikasi!</strong><br>
                Mohon segera tinjau detail laporan untuk memverifikasi kelengkapan dan validitas informasi yang diberikan.
            </div>
            <div class="next-steps">
                <h4>📋 Langkah Selanjutnya:</h4>
                <ul>
                    <li>Buka laporan melalui tombol di bawah.</li>
                    <li>Periksa detail dan bukti awal yang disertakan oleh pelapor.</li>
                    <li>Tentukan apakah laporan memerlukan data tambahan, dapat diproses, atau harus ditolak.</li>
                </ul>
            </div>
            <div style="text-align: center; margin-top: 25px;">
                <a href="{{route('track', ['code' => $report->code])}}" class="btn-action blue-dark">➡️ Tinjau Laporan Baru</a>
            </div>
        </div>
