    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div class="alert-box info">
                ...
                <p style="font-style: italic;">"Terima kasih banyak atas bantuannya. Prosesnya cepat dan saya merasa lebih aman sekarang. Penjelasannya juga sangat jelas."</p>
                <p><strong>Rating:</strong> 5 dari 5 Bintang</p>
            </div>
            <div class="next-steps">
                <h4>📋 Tindakan yang Direkomendasikan:</h4>
                <ul>
                    <li>Tinjau ulasan dan feedback yang diberikan oleh pelapor.</li>
                    <li>Gunakan feedback ini untuk mengevaluasi proses penanganan.</li>
                    <li>Identifikasi area yang dapat ditingkatkan berdasarkan masukan pelapor.</li>
                </ul>
            </div>
            <div style="text-align: center; margin-top: 25px;">
                <a href="{{route('track', ['code' => $report->code])}}" class="btn-action blue-light">➡️ Lihat Detail Feedback & Laporan</a>
            </div>
        </div>
