...
@section('content')
        ...
        <main id="content" class="content">
            ...
            <!-- Kategori Laporan Berdasarkan Tingkat Keparahan -->
            <div class="severity-section">
                <div class="severity-header">
                    <h3 class="section-title">Laporan Berdasarkan Tingkat Keparahan</h3>
                    <div class="stats-summary">
                        <span class="total-reports">Total: <strong>156</strong> Laporan selesai</span>
                    </div>
                </div>
